...
import com.app.mojezehsalamt.fragments.FragmentCategory;
import com.app.mojezehsalamt.fragments.FragmentRecentRecipes;
import com.app.mojezehsalamt.utilities.AppBarLayoutBehavior;

public class FragmentTabLayoutCategory extends Fragment {
    ...
    public FragmentTabLayoutCategory() {
    }
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new FragmentRecentRecipes();
                case 1:
    ...
    private void setupToolbar() {
        toolbar.setTitle(getString(R.string.drawer_category));
