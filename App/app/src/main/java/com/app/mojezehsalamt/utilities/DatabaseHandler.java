package com.app.mojezehsalamt.utilities;
...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	// Creating Tables
			...
			public	void AddtoFavorite(ItemFavorite pj)
			{
			...
			// Getting All Data
			public List<ItemFavorite> getAllData()
			{
				List<ItemFavorite> dataList = new ArrayList<ItemFavorite>();
				// Select All Query
				...
				{
					do {
						ItemFavorite contact = new ItemFavorite();
		...
		//getting single row
			...
			public List<ItemFavorite> getFavRow(String id)
			{
				List<ItemFavorite> dataList = new ArrayList<ItemFavorite>();
				// Select All Query
		...
		//for remove favorite
			...
			public void RemoveFav(ItemFavorite contact)
			{
			    SQLiteDatabase db = this.getWritableDatabase();
